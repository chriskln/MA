...
################################
# Set timeframe to 01/10/2019 - 23/08/2020
################################
...
start = pd.to_datetime("2019-10-01", format="%Y-%m-%d")
end = pd.to_datetime("2020-08-23", format="%Y-%m-%d")
...
##############################################
# Basic Summary Statistic (01/10/2019 - 23/08/2020)
##############################################
...
##############################################
# Summary Statistic in dependence of globe rating (01/10/2019 - 23/08/2020)
##############################################
...
d = {"Overall (01/01/2019 - 31/12/2020)": df_ttest, "Crash (23/02/2020 - 22/03/2020)": df_ttest_crsh,
     "Recovery (23/03/2020 - 23/08/2020)": df_ttest_rec}
...
d_2 = {"Overall means (01/01/2019 - 23/08/2020)": f}
